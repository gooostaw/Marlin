...
Usage: python createTemperatureLookupWRCNC.py [options]
...
def main(argv):
    ...
    print("// Thermistor lookup table for WRCNC")
    print("// ./createTemperatureLookupWRCNC.py --rp=%s --t1=%s:%s --t2=%s:%s --t3=%s:%s --num-temps=%s" % (rp, t1, r1, t2, r2, t3, r3, num_temps))
