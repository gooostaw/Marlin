...
class TFT_Queue {
  ...
  public:
    ...
    static void add_image(int16_t x, int16_t y, mvCNCImage image, uint16_t *colors);
    static void add_image(int16_t x, int16_t y, mvCNCImage image, uint16_t color_main, uint16_t color_background, uint16_t color_shadow);
