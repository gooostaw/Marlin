 ...
 * Defines the interaction between mvCNC and the display firmware
 */
...
// (Strictly this would not be necessary, but allows to only send data the display needs and reducing load on mvCNC)
struct VPMapping {
...
// List of VPs handled by mvCNC / The Display.
