...
/**
 * mvCNCSerial.h - Hardware serial library for Wiring
...
#include "../../core/serial_hook.h"
  ...
  // Registers used by mvCNCSerial class (expanded depending on selected serial port)
  ...
  typedef Serial1Class< mvCNCSerial< mvCNCSerialCfg<SERIAL_PORT> > > MSerialT1;
  extern MSerialT1 customizedSerial1;

  #ifdef SERIAL_PORT_2
    typedef Serial1Class< mvCNCSerial< mvCNCSerialCfg<SERIAL_PORT_2> > > MSerialT2;
    extern MSerialT2 customizedSerial2;
  #endif

  #ifdef SERIAL_PORT_3
    typedef Serial1Class< mvCNCSerial< mvCNCSerialCfg<SERIAL_PORT_3> > > MSerialT3;
  ...
  typedef Serial1Class< mvCNCSerial< MMU2SerialCfg<MMU2_SERIAL_PORT> > > MSerialMMU2;
  ...
  typedef Serial1Class< mvCNCSerial< LCDSerialCfg<LCD_SERIAL_PORT> > > MSerialLCD;
