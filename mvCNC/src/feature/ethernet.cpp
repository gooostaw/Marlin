...
bool mvCNCEthernet::hardware_enabled, // = false
     mvCNCEthernet::have_telnet_client; // = false

IPAddress mvCNCEthernet::ip,
          mvCNCEthernet::myDns,
          mvCNCEthernet::gateway,
          mvCNCEthernet::subnet;

EthernetClient  mvCNCEthernet::telnetClient;  // connected client

mvCNCEthernet ethernet;
...
void mvCNCEthernet::check() {
  ...
  switch (linkState) {
    ...
    case CONNECTING:
      telnetClient.println("mvCNC " SHORT_BUILD_VERSION);
