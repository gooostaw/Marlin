...
#define _PID_Kp(H)      TERN(PIDTEMP, Thermals::temp_hotend[H].pid.Kp, NAN)
#define _PID_Ki(H)      TERN(PIDTEMP, Thermals::temp_hotend[H].pid.Ki, NAN)
#define _PID_Kd(H)      TERN(PIDTEMP, Thermals::temp_hotend[H].pid.Kd, NAN)
#if ENABLED(PIDTEMP)
  #define _PID_Kc(H) TERN(PID_EXTRUSION_SCALING, Thermals::temp_hotend[H].pid.Kc, 1)
  #define _PID_Kf(H) TERN(PID_FAN_SCALING, Thermals::temp_hotend[H].pid.Kf, 0)
#else
  #define _PID_Kc(H) 1
  #define _PID_Kf(H) 0
#endif
...
// Minimum number of Thermals::ISR loops between sensor readings.
