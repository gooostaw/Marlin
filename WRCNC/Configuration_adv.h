...
// @section bltouch
   ...
   * V3.0 or 3.1: Set default mode to 5V mode at WRCNC startup.
   * If disabled, OD mode is the hard-coded default on 3.0
   * On startup, WRCNC will compare its eeprom to this value. If the selected mode
   ...
   * V3.0: Set a probe into mode selected above at WRCNC startup. Required for 5V mode on 3.0
   * V3.1: Force a probe with unknown mode into selected mode at WRCNC startup ( = Probe EEPROM write )
...
//#define BEEP_ON_FEEDRATE_CHANGE
...
#if HAS_BED_PROBE && EITHER(HAS_WRCNCUI_MENU, HAS_TFT_LVGL_UI)
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000
    ...
    #if EITHER(HAS_WRCNCUI_U8GLIB, TFT_COLOR_UI)
      #define BOOT_WRCNC_LOGO_SMALL     // Show a smaller WRCNC logo on the Boot Screen (saving lots of flash)
    #endif
  #endif
...
// LCD CNC Progress options
  ...
  #if EITHER(HAS_WRCNCUI_U8GLIB, EXTENSIBLE_UI)
    //#define PRINT_PROGRESS_SHOW_DECIMALS // Show progress with decimal digits
  #endif

  #if EITHER(HAS_WRCNCUI_HD44780, IS_TFTGLCD_PANEL)
   ...
   * WRCNC will embed all settings in the firmware binary as compressed data.
 ...
 */
  ...
  //#define BOOT_WRCNC_LOGO_ANIMATED // Animated WRCNC logo. Costs ~3260 (or ~940) bytes of PROGMEM.

  // Frivolous Game Options
  //#define WRCNC_BRICKOUT
  //#define WRCNC_INVADERS
  //#define WRCNC_SNAKE
  //#define GAMES_EASTER_EGG          // Add extra blank lines above the "Games" sub-menu

#endif // HAS_WRCNCUI_U8GLIB

#if HAS_WRCNCUI_U8GLIB || IS_DWIN_WRCNCUI
...
//
#if ANY(DOGLCD, TFT_COLOR_UI, TOUCH_UI_FTDI_EVE, IS_DWIN_WRCNCUI)
...
//
  ...
  //#define TFT_WRCNCUI_COLOR 0xFFFF // White
  //#define TFT_WRCNCBG_COLOR 0x0000 // Black
 ...
 *
 * See https://wrcncfw.org/docs/features/lin_advance.html for full instructions.
 */
//#define LIN_ADVANCE
 ...
 * For more details see https://wrcncfw.org/docs/features/probe_temp_compensation.html
 */
...
// #define REALTIME_COMMANDS
   ...
   *
   * Possible WRCNC statuses (GRBL-compatible equivalent)
...
// #define COMPACT_STATUS_REPORTS
  ...
  // #define GRBL_COMPATIBLE_STATES    // Report GRBL-equivalent states instead of WRCNC states
#endif

/**
 * Priority command execution
 *
 * When interacting using an attached WRCNC LCD display, changes such as babystepping and feed rates
 ...
 */
   ...
   * When disabled, WRCNC will use spreadCycle stepping mode.
   */
   ...
   * CHOPPER_WRCNC_119   // Old defaults from WRCNC v1.1.9
   *
   ...
   * To manage over-temp WRCNC can decrease the driver current until the error condition clears.
 ...
 */
   ...
   * In the case of over temperature WRCNC can decrease the drive until the error condition clears.
   * Other detected conditions can be used to stop the current print.
   * Relevant G-codes:
 ...
 *
 * ; Example #1
 * ; This macro send the string "WRCNC" to the slave device with address 0x63 (99)
 ...
 * WRCNC can be used to turn the spindle on and off. It can also be used to set
 * the spindle speed from 5,000 to 30,000 RPM.
 *
 * You'll need to select a pin for the ON/OFF function and optionally choose a 0-5V
 * hardware PWM pin for the speed control and a pin for the rotation direction.
 *
 * See https://wrcncfw.org/docs/configuration/laser_spindle.html for more config details.
 */
 ...
 *
 * WRCNC normally applies M106/M107 fan speeds at a time "soon after" processing
 ...
 *
 * If the SAFE_POWER_PIN is defined for your board, WRCNC will check
...
/**
 * Enable this option for a leaner build of WRCNC that removes all
 * workspace offsets, simplifying coordinate transformations, leveling, etc.
 *
 *  - M206 and M428 are disabled.
 *  - G92 will revert to its behavior from WRCNC 1.0.
 */
 ...
 *
 * Host Prompt Support enables WRCNC to use the host for user prompts so
 ...
 * Cancel Objects
 *
 * Implement M486 to allow WRCNC to skip objects
 */
 ...
 */
//#define WIFISUPPORT         // WRCNC embedded WiFi managenent
...
// Enable WRCNC dev mode which adds some special commands
//#define WRCNC_DEV_MODE

#if ENABLED(WRCNC_DEV_MODE)
  /**
