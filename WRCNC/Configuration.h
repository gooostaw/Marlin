 ...
 *
 * Example Configs:     https://github.com/WRCNCFirmware/Configurations/branches/all
 *
 ...
 * *** VENDORS PLEASE READ ***
 *
 * WRCNC allows you to add a custom boot image for Graphical LCDs.
 * With this option WRCNC will first show your custom screen followed
 * by the standard WRCNC logo with version number and web URL.
 *
 * We encourage you to take advantage of this new feature and we also
 * respectfully request that you retain the unmodified WRCNC boot screen.
 */

// Show the WRCNC bootscreen on startup. ** ENABLE FOR PRODUCTION **
#define SHOW_BOOTSCREEN

// Show the bitmap in WRCNC/_Bootscreen.h on startup.
#define SHOW_CUSTOM_BOOTSCREEN

// Show the bitmap in WRCNC/_Statusscreen.h on the status screen.
 ...
 * See https://github.com/DerAndere1/WRCNC/wiki
 ...
 * Stepper Drivers
 *
 * These settings allow WRCNC to tune stepper driver timing and enable advanced options for
 ...
 *   https://blog.kyneticcnc.com/2018/10/computing-junction-deviation-for-wrcnc.html
 */
...
//
// See https://wrcncfw.org/docs/configuration/probes.html
//
 ...
 *
 * WRCNC automatically computes skew factors from these measurements.
...
// Host Keepalive
//
// When enabled WRCNC will send a busy status message to the host
 ...
 *
 * See https://wrcncfw.org/docs/development/lcd_language.html
 *
...
// By default WRCNC assumes you have a buzzer with a fixed frequency.
//
#define SPEAKER
...
//
// Flash display with DGUS Displays for WRCNC:
//  - Format the SD card to FAT32 with an allocation size of 4kb.
//  - Download files as specified for your type of display.
//  - Plug the microSD card into the back of the display.
//  - Boot the display and wait for the update to complete.
//
// ORIGIN (WRCNC DWIN_SET)
//  - Download https://github.com/coldtobi/WRCNC_DGUS_Resources
 ...
 *   TFT_COLOR_UI   - WRCNC Default Menus, Touch Friendly, using full TFT capabilities
...
//#define DWIN_WRCNCUI_PORTRAIT      // WRCNCUI (portrait orientation)
//#define DWIN_WRCNCUI_LANDSCAPE     // WRCNCUI (landscape orientation)
