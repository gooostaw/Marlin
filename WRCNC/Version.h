...
/**
 * WRCNC release version identifier
 */
...
/**
 * The SOURCE_CODE_URL is the location where users will find the WRCNC Source
 ...
 * documentation about a specific WRCNC release.
 */
