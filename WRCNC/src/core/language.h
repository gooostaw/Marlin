...
//
//   ==> ALWAYS TRY TO COMPILE WRCNC WITH/WITHOUT "ULTIPANEL" / "ULTRA_LCD" / "SDSUPPORT" #define IN "Configuration.h"
...
#define WRCNC_WEBSITE_URL "wrcncfw.org"
...
#else
  //
  // Custom characters from WRCNC_symbols.fon which was merged into ISO10646-0-3.bdf
 ...
 * However, internal to WRCNC E0/T0 is the first tool, and
