...
/**
 * WRCNC uses the Bresenham algorithm. For a detailed explanation of theory and
...
void Stepper::set_directions() {
   ...
   *  the curve, as WRCNC uses variable timer periods. So, we require a formula of the form:
   *
