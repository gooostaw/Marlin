...
//
  ...
  //#define SPI_EEPROM
  //#define HAS_SPI_FLASH                      1  // need WRCNC_DEV_MODE for M993/M994 eeprom backup tests
  ...
  #define WRCNC_EEPROM_SIZE 16UL * (EEPROM_PAGE_SIZE)   // Limit to 64KB for now...
#elif HAS_SPI_FLASH
  ...
  #define WRCNC_EEPROM_SIZE (EEPROM_PAGE_SIZE)
#else
  #define WRCNC_EEPROM_SIZE              0x800U  // On SD, Limit to 2KB, require this amount of RAM
#endif
