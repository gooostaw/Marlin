...
//
  ...
  #define WRCNC_EEPROM_SIZE    EEPROM_PAGE_SIZE  // 2KB
#endif
...
//
   ...
   * because WRCNC uses the reset as a failsafe to revive a glitchy LCD.
   */
  ...
  #define TFT_RS_PIN                 FSMC_RS_PIN
    ...
    #define TFT_WRCNCBG_COLOR            0x3186  // Grey
    #define TFT_WRCNCUI_COLOR            0xC7B6  // Green
