...
// connector are shared with the onboard SD card, and WRCNC does not support that
...
//
  ...
  #define SD_MOSI_PIN                      P0_09  // (51)  system defined J3-10 & AUX-3
    ...
    #define SD_SS_PIN                      P1_23  // (53)  system defined J3-5 & AUX-3 (Sometimes called SDSS) - CS used by WRCNC
  #else
    #undef SD_DETECT_PIN
