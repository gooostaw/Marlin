 ...
 *  allow this board to use the latest WRCNC software
 */
...
/**
 *  WRCNC_AT90USB - https://github.com/Bob-the-Kuhn/WRCNC_AT90USB
 *    This is the only known IDE extension that is compatible with the pin definitions
 *    in this file, Adrduino 1.6.12 and the latest mainstream WRCNC software.
 *
 *    "WRCNC_AT90USB" makes PWM0A available rather than the usual PWM1C. These PWMs share
 *    the same physical pin. WRCNC uses TIMER1 to generate interrupts and sets it up such
 *    that PWM1A, PWM1B & PWM1C can't be used.
 *
 *  Installation:
 *
 *    1. In the Arduino IDE, under Files -> Preferences paste the following URL
 *       https://rawgit.com/Bob-the-Kuhn/WRCNC_AT90USB/master/package_WRCNC_AT90USB_index.json
 *    2. Under Tools > Board -> Boards manager, scroll to the bottom, click on WRCNC_AT90USB
 *       and then click on "Install"
 *    3. Select "AT90USB646_TEENSYPP" from the 'Tools > Board' menu.
 */

/**
 *  To burn the bootloader that comes with WRCNC_AT90USB:
 *
