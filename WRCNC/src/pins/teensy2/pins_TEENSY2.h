 ...
 *  and with the mainstream WRCNC software.
 *
 *  Teensyduino - https://www.pjrc.com/teensy/teensyduino.html
 *    Select Teensy++ 2.0 in Arduino IDE from the 'Tools > Board' menu
 *
 *    Installation instructions are at the above URL.  Don't bother loading the
 *    libraries - they are not used with the WRCNC software.
 *
...
// Steppers
//
#define X_STEP_PIN                            28  // A0 WRCNC
#define X_DIR_PIN                             29  // A1 WRCNC
#define X_ENABLE_PIN                          26  // B6

#define Y_STEP_PIN                            30  // A2 WRCNC
