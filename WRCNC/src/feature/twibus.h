...
/**
 * For a light i2c protocol that runs on two boards running WRCNC see:
 ...
 * WRCNC to send and request data from any slave device on the bus.
 *
 ...
 *    - https://wrcncfw.org/docs/gcode/M260.html
 *    - https://wrcncfw.org/docs/gcode/M261.html
 */
class TWIBus {
  private:
    /**
