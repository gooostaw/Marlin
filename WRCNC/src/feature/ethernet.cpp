...
bool WRCNCEthernet::hardware_enabled, // = false
     WRCNCEthernet::have_telnet_client; // = false

IPAddress WRCNCEthernet::ip,
          WRCNCEthernet::myDns,
          WRCNCEthernet::gateway,
          WRCNCEthernet::subnet;

EthernetClient  WRCNCEthernet::telnetClient;  // connected client

WRCNCEthernet ethernet;
...
void WRCNCEthernet::check() {
  ...
  switch (linkState) {
    ...
    case CONNECTING:
      telnetClient.println("WRCNC " SHORT_BUILD_VERSION);
