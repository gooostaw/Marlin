...
void SpindleLaser::init() {
    ...
    TERN_(WRCNC_DEV_MODE, frequency = SPINDLE_LASER_FREQUENCY);
  #endif
  ...
  void SpindleLaser::_set_ocr(const uint8_t ocr) {
    #if ENABLED(HAL_CAN_SET_PWM_FREQ) && SPINDLE_LASER_FREQUENCY
      set_pwm_frequency(pin_t(SPINDLE_LASER_PWM_PIN), TERN(WRCNC_DEV_MODE, frequency, SPINDLE_LASER_FREQUENCY));
    #endif
