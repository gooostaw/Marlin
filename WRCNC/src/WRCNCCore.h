...
extern WRCNCState wrcnc_state;
inline bool IsRunning() { return wrcnc_state >= MF_RUNNING; }
inline bool IsStopped() { return wrcnc_state == MF_STOPPED; }
