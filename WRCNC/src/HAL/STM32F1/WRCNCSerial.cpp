...
// Not every WRCNCSerial port should handle emergency parsing.
...
#define DEFINE_HWSERIAL_WRCNC(name, n)     \
...
#define DEFINE_HWSERIAL_UART_WRCNC(name, n) \
  MSerialT name(serial_handles_emergency(n), \
          UART##n,                           \
          BOARD_USART##n##_TX_PIN,           \
          BOARD_USART##n##_RX_PIN);          \
...
// port which may be in use on the system.
  ...
  DEFINE_HWSERIAL_WRCNC(MSerial1, 1);
#endif
DEFINE_HWSERIAL_WRCNC(MSerial2, 2);
DEFINE_HWSERIAL_WRCNC(MSerial3, 3);
#if EITHER(STM32_HIGH_DENSITY, STM32_XL_DENSITY)
  DEFINE_HWSERIAL_UART_WRCNC(MSerial4, 4);
  DEFINE_HWSERIAL_UART_WRCNC(MSerial5, 5);
#endif
