...
/**
 * WRCNCSerial.h - Hardware serial library for Wiring
...
#include "../../core/serial_hook.h"
  ...
  // Registers used by WRCNCSerial class (expanded depending on selected serial port)
  ...
  typedef Serial1Class< WRCNCSerial< WRCNCSerialCfg<SERIAL_PORT> > > MSerialT1;
  extern MSerialT1 customizedSerial1;

  #ifdef SERIAL_PORT_2
    typedef Serial1Class< WRCNCSerial< WRCNCSerialCfg<SERIAL_PORT_2> > > MSerialT2;
    extern MSerialT2 customizedSerial2;
  #endif

  #ifdef SERIAL_PORT_3
    typedef Serial1Class< WRCNCSerial< WRCNCSerialCfg<SERIAL_PORT_3> > > MSerialT3;
  ...
  typedef Serial1Class< WRCNCSerial< MMU2SerialCfg<MMU2_SERIAL_PORT> > > MSerialMMU2;
  ...
  typedef Serial1Class< WRCNCSerial< LCDSerialCfg<LCD_SERIAL_PORT> > > MSerialLCD;
