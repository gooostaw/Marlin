...
uint8_t L64XX_WRCNC::transfer_single(uint8_t data, int16_t ss_pin) {
...
uint8_t L64XX_WRCNC::transfer_chain(uint8_t data, int16_t ss_pin, uint8_t chain_position) {
  uint8_t data_out = 0;
 ...
 */
void L64XX_WRCNC::transfer(uint8_t L6470_buf[], const uint8_t length) {
