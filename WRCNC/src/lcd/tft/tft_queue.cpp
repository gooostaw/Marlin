...
void TFT_Queue::add_image(int16_t x, int16_t y, WRCNCImage image, uint16_t *colors) {
...
void TFT_Queue::add_image(int16_t x, int16_t y, WRCNCImage image, uint16_t color_main, uint16_t color_background, uint16_t color_shadow) {
  uint16_t colors[16];
  colorMode_t color_mode = Images[image].colorMode;
  uint16_t i;
