...
const tImage NoLogo                 = { nullptr, 0, 0, NOCOLORS };
  ...
  const tImage WRCNCLogo112x38x1   = { (void *)wrcnc_logo_112x38x1, 112, 38, GREYSCALE1 };
  const tImage WRCNCLogo228x255x2  = { (void *)wrcnc_logo_228x255x2, 228, 255, GREYSCALE2 };
  const tImage WRCNCLogo228x255x4  = { (void *)wrcnc_logo_228x255x4, 228, 255, GREYSCALE4 };
  const tImage WRCNCLogo195x59x16  = { (void *)wrcnc_logo_195x59x16,  195,  59, HIGHCOLOR };
  const tImage WRCNCLogo320x240x16 = { (void *)wrcnc_logo_320x240x16, 320, 240, HIGHCOLOR };
  const tImage WRCNCLogo480x320x16 = { (void *)wrcnc_logo_480x320x16, 480, 320, HIGHCOLOR };
#endif
...
const tImage Images[imgCount] = {
  TERN(SHOW_BOOTSCREEN, TERN(BOOT_WRCNC_LOGO_SMALL, WRCNCLogo195x59x16, WRCNC_LOGO_FULL_SIZE), NoLogo),
  HotEnd_64x64x4,
  Bed_64x64x4,
  Bed_Heated_64x64x4,
  Chamber_64x64x4,
