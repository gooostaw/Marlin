...
void WRCNCUI::tft_idle() {
  ...
  void WRCNCUI::show_bootscreen() {
    ...
    #if ENABLED(BOOT_WRCNC_LOGO_SMALL)
      #define BOOT_LOGO_W 195   // WRCNCLogo195x59x16
      #define BOOT_LOGO_H  59
      #define SITE_URL_Y (TFT_HEIGHT - 70)
      tft.set_background(COLOR_BACKGROUND);
    #else
      #define BOOT_LOGO_W TFT_WIDTH   // WRCNCLogo480x320x16
...
static void drawBtn(int x, int y, const char *label, intptr_t data, WRCNCImage img, uint16_t bgColor, bool enabled = true) {
