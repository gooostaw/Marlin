...
#include "../wrcncui.h"  // for ui methods
...
bool WRCNCUI::touch_pressed() {
  return touch.is_clicked();
}

void add_control(uint16_t x, uint16_t y, TouchControlType control_type, intptr_t data, WRCNCImage image, bool is_enabled, uint16_t color_enabled, uint16_t color_disabled) {
