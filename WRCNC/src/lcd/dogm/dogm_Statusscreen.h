...
/**
 * Standard WRCNC Status Screen bitmaps
 *
 * Use the WRCNC Bitmap Converter to make your own:
 * https://wrcncfw.org/tools/u8glib/converter.html
 */
...
#define BW(N) ((N + 7) / 8)
  ...
  #include "../../../_Statusscreen.h"
    ...
    #error "Your custom _Statusscreen.h needs to be converted for WRCNC 2.0."
  #endif
