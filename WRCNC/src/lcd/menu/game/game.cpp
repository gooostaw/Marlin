...
int WRCNCGame::score;
uint8_t WRCNCGame::game_state;
millis_t WRCNCGame::next_frame;

WRCNCGameData wrcnc_game_data;

bool WRCNCGame::game_frame() {
  static int8_t slew;
...
void WRCNCGame::init_game(const uint8_t init_state, const screenFunc_t screen) {
  score = 0;
