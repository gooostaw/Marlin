...
//
void WRCNCUI::ubl_mesh_edit_start(const_float_t initial) {
...
//
float WRCNCUI::ubl_mesh_value() { return rounded_mesh_value(); }
...
#endif // HAS_WRCNCUI_MENU && AUTO_BED_LEVELING_UBL
