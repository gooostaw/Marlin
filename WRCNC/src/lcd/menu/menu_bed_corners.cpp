...
#if BOTH(HAS_WRCNCUI_MENU, LEVEL_BED_CORNERS)
 ...
 */
  ...
  void _lcd_draw_probing() {
    ...
    TERN_(HAS_WRCNCUI_U8GLIB, ui.set_font(FONT_MENU)); // Set up the font for extra info
...
#endif // HAS_WRCNCUI_MENU && LEVEL_BED_CORNERS
