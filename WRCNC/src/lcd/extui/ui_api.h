...
namespace ExtUI {
  ...
  GcodeSuite::WRCNCBusyState getHostKeepaliveState();
  ...
  /**
   * Getters and setters
   * Should be used by the EXTENSIBLE_UI to query or change WRCNC's state.
   */
  ...
  inline void simulateUserClick() {
    #if ANY(HAS_WRCNCUI_MENU, EXTENSIBLE_UI, DWIN_CREALITY_LCD_JYERSUI)
      ui.lcd_clicked = true;
    #endif
  }
   ...
   *
   * Should be declared by EXTENSIBLE_UI and will be called by WRCNC
   */
  void onStartup();
  void onIdle();
