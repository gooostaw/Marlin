...
#define TFTSer LCD_SERIAL                    // Serial interface for TFT panel now uses WRCNCSerial
...
#define WRCNC_msg_nozzle_parked       PSTR("Nozzle Parked")
#define WRCNC_msg_heater_timeout      PSTR("Heater Timeout")
#define WRCNC_msg_reheating           PSTR("Reheating...")
#define WRCNC_msg_reheat_done         PSTR("Reheat finished.")
#define WRCNC_msg_filament_purging    PSTR("Filament Purging...")
#define WRCNC_msg_special_pause       PSTR("PB")

#define AC_cmnd_auto_unload_filament   F("M701")                    // Use WRCNC unload routine
#define AC_cmnd_auto_load_filament     F("M702 M0 PB")              // Use WRCNC load routing then pause for user to clean nozzle
