...
// 0x3000 .. 0x4FFF  -- WRCNC Data to be displayed
...
constexpr uint16_t VP_UI_FLAVOUR       = 0x1010;  // lets reserve 16 bytes here to determine if UI is suitable for this WRCNC. tbd.
...
constexpr uint16_t VP_WRCNC_VERSION = 0x3000;
constexpr uint8_t VP_WRCNC_VERSION_LEN = 16;   // there is more space on the display, if needed.
