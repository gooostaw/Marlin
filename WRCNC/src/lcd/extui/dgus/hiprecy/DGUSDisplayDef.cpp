...
/* DGUS VPs changed by George Fu in 2019 for WRCNC */
...
const char WRCNCVersion[] PROGMEM = SHORT_BUILD_VERSION;
...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  { .VP = VP_WRCNC_VERSION, .memadr = (void*)WRCNCVersion, .size = VP_WRCNC_VERSION_LEN, .set_by_display_handler = nullptr, .send_to_display_handler = ScreenHandler.DGUSLCD_SendStringToDisplayPGM },
