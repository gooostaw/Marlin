...
public:
  ...
  static void HandleHeaterControl(DGUS_VP_Variable &var, void *val_ptr);
    ...
    // WRCNC informed us that a new SD has been inserted.
    static void SDCardInserted();
    // WRCNC informed us that the SD Card has been removed().
    static void SDCardRemoved();
    // WRCNC informed us about a bad SD Card.
    static void SDCardError();
    // WRCNC informed us about SD print completion.
