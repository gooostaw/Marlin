...
/********************************************************************************
 * @file     lcd/e3v2/wrcncui/dwin_lcd.h
...
#define DWIN_WRCNCUI_Assets 2

// ICON ID
#define BOOT_ICON           3 // Icon set file 3.ICO
#define ICON                4 // Icon set file 4.ICO

// WRCNCUI Boot Icons from Set 3
#define ICON_WRCNCBoot            0
#define ICON_OpenSource            1
#define ICON_GitHubURL             2
#define ICON_WRCNCURL             3
#define ICON_Copyright             4

// WRCNCUI Icons from Set 4
#define ICON_LOGO_WRCNC           0
