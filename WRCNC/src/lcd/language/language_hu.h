 ...
 * Hungarian / Magyar
 *
 * LCD Menu Messages. See also https://wrcncfw.org/docs/development/lcd_language.html
 ...
 *
 * LCD Menü Üzenetek. Lásd még https://wrcncfw.org/docs/development/lcd_language.html
