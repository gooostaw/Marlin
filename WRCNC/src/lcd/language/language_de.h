...
namespace Language_de {
  ...
  LSTR MSG_SET_ORIGIN                     = _UxGT("Setze Nullpunkte"); //"G92 X0 Y0 Z0" commented out in wrcncui.cpp
  #if HAS_PREHEAT
  ...
  LSTR MSG_RELEASE_MEDIA                  = _UxGT("Medium freigeben"); // if WRCNC gets confused - M22
