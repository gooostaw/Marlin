...
void GCodeParser::parse(char *p) {
  ...
  #if ANY(WRCNC_DEV_MODE, SWITCHING_TOOLHEAD, MAGNETIC_SWITCHING_TOOLHEAD, ELECTROMAGNETIC_SWITCHING_TOOLHEAD)
   ...
   */
  switch (letter) {
    case 'G': case 'M': case 'T': TERN_(WRCNC_DEV_MODE, case 'D':) {
