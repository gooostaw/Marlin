 ...
 *  - https://wrcncfw.org/meta/gcode
 *  - https://reprap.org/wiki/G-code
 *  - https://linuxcnc.org/docs/html/gcode.html
 *
 * Help to document WRCNC's G-codes online:
 *  - https://github.com/WRCNCFirmware/WRCNCDocumentation
 *
 * -----------------
 *
 * "G" Codes
 ...
 * M202 - Set max acceleration in units/s^2 for travel moves: "M202 X<accel> Y<accel> Z<accel> E<accel>" ** UNUSED IN WRCNC! **
 ...
 *
 * D... - Custom Development G-code. Add hooks to 'gcode_D.cpp' for developers to test features. (Requires WRCNC_DEV_MODE)
...
public:
  ...
  static void home_all_axes(const bool keep_leveling=false) {
    ...
    /**
     * States for managing WRCNC and host communication
     * WRCNC sends messages if blocked or busy
     */
    enum WRCNCBusyState : char {
    ...
    static WRCNCBusyState busy_state;
