...
#include "../../module/temperature.h"
  ...
  // Workarounds for keeping WRCNC's watchdog timer from barking...
  void wrcnc_yield() {
    thermalManager.manage_heater();
  }
  #define SYSTEM_OR_SPECIAL_YIELD(...) wrcnc_yield();
  ...
  #define WRCNC_UHS_WRITE_SS(v) WRITE(USB_CS_PIN, v)
  #define WRCNC_UHS_READ_IRQ()  READ(USB_INTR_PIN)
...
// WRCNC calls this function to check whether an USB drive is inserted.
...
// WRCNC calls this to initialize an SD card once it is inserted.
