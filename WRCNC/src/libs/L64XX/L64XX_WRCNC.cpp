...
#include "L64XX_WRCNC.h"

L64XX_WRCNC L64xxManager;
...
PGM_P const L64XX_WRCNC::index_to_axis[] PROGMEM = {
...
uint8_t L64XX_WRCNC::dir_commands[MAX_L64XX];  // array to hold direction command for each driver

#define _EN_ITEM(N) , INVERT_E##N##_DIR
const uint8_t L64XX_WRCNC::index_to_dir[MAX_L64XX] = {
...
volatile uint8_t L64XX_WRCNC::spi_abort = false;
uint8_t L64XX_WRCNC::spi_active = false;

L64XX_WRCNC::L64XX_shadow_t L64XX_WRCNC::shadow;
 ...
 */
uint16_t L64XX_WRCNC::get_stepper_status(L64XX &st) {
...
void L64XX_WRCNC::init() {               // Set up SPI and then init chips
...
uint16_t L64XX_WRCNC::get_status(const L64XX_axis_t axis) {
...
uint32_t L64XX_WRCNC::get_param(const L64XX_axis_t axis, const uint8_t param) {
...
void L64XX_WRCNC::set_param(const L64XX_axis_t axis, const uint8_t param, const uint32_t value) {
...
uint8_t L64XX_WRCNC::get_user_input(uint8_t &driver_count, L64XX_axis_t axis_index[3],  char axis_mon[3][3],
...
void L64XX_WRCNC::say_axis(const L64XX_axis_t axis, const uint8_t label/*=true*/) {
  ...
  void L64XX_WRCNC::error_status_decode(const uint16_t status, const L64XX_axis_t axis,
...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  bool L64XX_WRCNC::monitor_paused = false; // Flag to skip monitor during M122, M906, M916, M917, M918, etc.
  ...
  void L64XX_WRCNC::append_stepper_err(char* &p, const uint8_t stepper_index, const char * const err/*=nullptr*/) {
  ...
  void L64XX_WRCNC::monitor_update(L64XX_axis_t stepper_index) {
  ...
  void L64XX_WRCNC::monitor_driver() {
