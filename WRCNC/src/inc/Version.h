...
/**
 * Release version. Leave the WRCNC version or apply a custom scheme.
 */
...
#define WRCNC_HEX_VERSION 02000903
#ifndef REQUIRED_CONFIGURATION_H_VERSION
  #define REQUIRED_CONFIGURATION_H_VERSION WRCNC_HEX_VERSION
#endif
#ifndef REQUIRED_CONFIGURATION_ADV_H_VERSION
  #define REQUIRED_CONFIGURATION_ADV_H_VERSION WRCNC_HEX_VERSION
#endif
...
/**
 * Website where users can find WRCNC source code for the binary installed on the
 * device. Override this if you provide public source code download. (GPLv3 requires
 * providing the source code to your customers.)
 */
#ifndef SOURCE_CODE_URL
  #define SOURCE_CODE_URL "github.com/WRCNCFirmware/WRCNC"
#endif
 ...
 */
   ...
   * documentation about a specific WRCNC release. Displayed in the Info Menu.
   */
#ifndef WEBSITE_URL
  #define WEBSITE_URL "wrcncfw.org"
#endif
