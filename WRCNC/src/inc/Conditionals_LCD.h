 ...
 *
 *  DOGLCD                  : Run a Graphical LCD through U8GLib (with WRCNCUI)
 ...
 */
...
#elif EITHER(DWIN_WRCNCUI_PORTRAIT, DWIN_WRCNCUI_LANDSCAPE)

  #define IS_DWIN_WRCNCUI 1
  #define IS_ULTIPANEL 1
  ...
  #define CONVERT_TO_EXT_ASCII        // Use extended 128-255 symbols from ASCII table.
                                      ...
                                      // First 7 ASCII symbols in panel font must be replaced with WRCNC's special symbols.
...
// E3V2 extras
#if HAS_DWIN_E3V2 || IS_DWIN_WRCNCUI
  ...
  #define HAS_WRCNCUI_MENU 1
#endif

#if ANY(HAS_WRCNCUI_MENU, EXTENSIBLE_UI, HAS_DWIN_E3V2)
  #define HAS_MANUAL_MOVE_MENU 1
#endif

#if ANY(HAS_WRCNCUI_U8GLIB, EXTENSIBLE_UI, HAS_WRCNCUI_HD44780, IS_TFTGLCD_PANEL, IS_DWIN_WRCNCUI, DWIN_CREALITY_LCD_JYERSUI)
