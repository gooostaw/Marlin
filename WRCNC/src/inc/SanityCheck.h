 ...
 */
  ...
  #error "WRCNC requires C++11 support (gcc >= 4.7, Arduino IDE >= 1.6.8). Please upgrade your toolchain."
#endif
 ...
 * your settings to new Configuration files matching your WRCNC version as soon as possible.
 */
#define HEXIFY(H) _CAT(0x,H)
#if !defined(CONFIGURATION_H_VERSION) || HEXIFY(CONFIGURATION_H_VERSION) < HEXIFY(REQUIRED_CONFIGURATION_H_VERSION)
  #error "Your Configuration.h file is for an old version of WRCNC. Downgrade WRCNC or upgrade your Configuration.h."
#elif HEXIFY(CONFIGURATION_H_VERSION) > HEXIFY(REQUIRED_CONFIGURATION_H_VERSION)
  #error "Your Configuration.h file is for a newer version of WRCNC. Upgrade WRCNC or downgrade your Configuration.h."
#endif
#if !defined(CONFIGURATION_ADV_H_VERSION) || HEXIFY(CONFIGURATION_ADV_H_VERSION) < HEXIFY(REQUIRED_CONFIGURATION_ADV_H_VERSION)
  #error "Your Configuration_adv.h file is for an old version of WRCNC. Downgrade WRCNC or upgrade your Configuration_adv.h."
#elif HEXIFY(CONFIGURATION_ADV_H_VERSION) > HEXIFY(REQUIRED_CONFIGURATION_ADV_H_VERSION)
  #error "Your Configuration_adv.h file is for a newer version of WRCNC. Upgrade WRCNC or downgrade your Configuration_adv.h."
#endif
#undef HEXIFY
...
/**
 * WRCNC release, version and default string
 */
...
/**
 * Granular software endstops (WRCNC >= 1.1.7)
 */
 ...
 */
  ...
  #if HAS_WRCNCUI_U8GLIB || LCD_WIDTH < 20 || LCD_HEIGHT < 4
 ...
 */
  ...
  #endif
#elif ENABLED(LCD_SET_PROGRESS_MANUALLY) && NONE(HAS_WRCNCUI_U8GLIB, HAS_GRAPHICAL_TFT, HAS_WRCNCUI_HD44780, EXTENSIBLE_UI, HAS_DWIN_E3V2, IS_DWIN_WRCNCUI)
  #error "LCD_SET_PROGRESS_MANUALLY requires LCD_PROGRESS_BAR, Character LCD, Graphical LCD, TFT, DWIN_CREALITY_LCD, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI, DWIN_WRCNCUI_*, OR EXTENSIBLE_UI."
#endif
...
#if !HAS_WRCNCUI_MENU && ENABLED(SD_REPRINT_LAST_SELECTED_FILE)
  #error "SD_REPRINT_LAST_SELECTED_FILE currently requires a WRCNC-native LCD menu."
#endif

/**
 * Custom Boot and Status screens
 */
#if ENABLED(SHOW_CUSTOM_BOOTSCREEN) && NONE(HAS_WRCNCUI_U8GLIB, TOUCH_UI_FTDI_EVE)
  #error "SHOW_CUSTOM_BOOTSCREEN requires Graphical LCD or TOUCH_UI_FTDI_EVE."
#elif ENABLED(CUSTOM_STATUS_SCREEN_IMAGE) && !HAS_WRCNCUI_U8GLIB
 ...
 * SD Card Settings
 */
#if ALL(SDSUPPORT, ELB_FULL_GRAPHIC_CONTROLLER, HAS_WRCNCUI_MENU) && PIN_EXISTS(SD_DETECT) && SD_DETECT_STATE != HIGH && (SD_CONNECTION_IS(LCD) || !defined(SDCARD_CONNECTION))
 ...
 */
  ...
  #elif ENABLED(BABYSTEP_ZPROBE_GFX_OVERLAY) && NONE(HAS_WRCNCUI_U8GLIB, IS_DWIN_WRCNCUI)
 ...
 */
  ...
  #elif ENABLED(MMU_EXTRUDER_SENSOR) && !HAS_WRCNCUI_MENU
    #error "MMU_EXTRUDER_SENSOR requires an LCD supporting WRCNCUI."
  #elif ENABLED(MMU2_MENUS) && !HAS_WRCNCUI_MENU
    #error "MMU2_MENUS requires an LCD supporting WRCNCUI."
  #elif DISABLED(ADVANCED_PAUSE_FEATURE)
 ...
 */
  ...
  #endif
  static_assert(EXTRUDERS <= MAX_EXTRUDERS, "WRCNC supports a maximum of " STRINGIFY(MAX_EXTRUDERS) " EXTRUDERS.");
  #undef MAX_EXTRUDERS
 ...
 */
  ...
  static_assert(
    ...
    "LIN_ADVANCE_K must be a value from 0 to 10 (Changed in LIN_ADVANCE v1.5, WRCNC 1.1.9)."
  );
 ...
 */
#if HAS_WRCNCUI_HD44780 && !defined(DISPLAY_CHARSET_HD44780)
 ...
 */
  ...
  #error "Leveling in WRCNC requires three or more axes, with Z as the vertical axis."
 ...
 */
  ...
  #elif ENABLED(DELTA_AUTO_CALIBRATION) && !(HAS_BED_PROBE || HAS_WRCNCUI_MENU)
    #error "DELTA_AUTO_CALIBRATION requires a probe or LCD Controller."
  #elif ENABLED(DELTA_CALIBRATION_MENU) && !HAS_WRCNCUI_MENU
 ...
 */
  ...
  #elif NONE(HAS_WRCNCUI_U8GLIB, IS_DWIN_WRCNCUI)
 ...
 */
  ...
  #if NONE(HAS_WRCNCUI_MENU, DWIN_CREALITY_LCD, DWIN_CREALITY_LCD_ENHANCED)
 ...
 */
  ...
  + COUNT_ENABLED(DWIN_CREALITY_LCD, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI, DWIN_WRCNCUI_PORTRAIT, DWIN_WRCNCUI_LANDSCAPE) \
...
#if ENABLED(LED_CONTROL_MENU) && NONE(HAS_WRCNCUI_MENU, DWIN_CREALITY_LCD_ENHANCED)
...
#if NONE(HAS_WRCNCUI_U8GLIB, EXTENSIBLE_UI, IS_DWIN_WRCNCUI) && ENABLED(PRINT_PROGRESS_SHOW_DECIMALS)
 ...
 */
  ...
  #if NONE(HAS_WRCNCUI_MENU, PASSWORD_UNLOCK_GCODE, PASSWORD_CHANGE_GCODE)
