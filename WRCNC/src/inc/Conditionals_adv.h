...
#if ANY(WRCNC_BRICKOUT, WRCNC_INVADERS, WRCNC_SNAKE, WRCNC_MAZE)
  #define HAS_GAMES 1
  #if MANY(WRCNC_BRICKOUT, WRCNC_INVADERS, WRCNC_SNAKE, WRCNC_MAZE)
...
#if ANY(AUTO_BED_LEVELING_UBL, M100_FREE_MEMORY_WATCHER, DEBUG_GCODE_PARSER, TMC_DEBUG, WRCNC_DEV_MODE)
