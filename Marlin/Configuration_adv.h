...
#define HOMING_BACKOFF_POST_MM { 5, 5, 3 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define G38_PROBE_TARGET
  ...
  #define G38_MINIMUM_MOVE 0.00015625 // (mm) Minimum distance that will produce a move.
#endif
...
//TODO:
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       763        // (mA) RMS current. Multiply by 1.414 for peak current.
...
#define G0_FEEDRATE 1200 // (mm/min)
#ifdef G0_FEEDRATE
